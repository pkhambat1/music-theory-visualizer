...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--d3-primary)] focus:ring-offset-0 disabled:opacity-40 disabled:pointer-events-none select-none",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--d3-primary)] text-white font-semibold hover:bg-[var(--d3-primaryHover)] active:bg-[var(--d3-primary)]",
        ghost:
          "bg-transparent text-gray-600 hover:bg-gray-100 hover:text-gray-900",
        destructive:
          "bg-red-500/80 text-white hover:bg-red-500",
        outline:
          "border border-[var(--d3-border)] bg-white hover:bg-gray-50 text-gray-700",
        secondary: "bg-gray-100 text-gray-700 hover:bg-gray-200",
        link: "text-[var(--d3-primary)] underline-offset-4 hover:underline",
      },
      size: {
